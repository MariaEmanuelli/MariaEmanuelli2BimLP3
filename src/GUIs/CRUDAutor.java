...
public class CRUDAutor extends JDialog {
    ...
    private void habilitarAtributos(boolean id, boolean nome, boolean dataNascimento) {
        if (id) {
        ...
        btnRetrieve.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if (textFieldId.getText().equals("")) {
                    ...
                    editora.setIdAutor(Integer.valueOf(textFieldId.getText()));
                    editora = cl.obter(editora.getIdAutor());
                    if (editora != null) { //se encontrou na lista
                        textFieldNome.setText(editora.getNomeAutor());
                        textFieldDataNascimento.setText(sdf.format(editora.getDataNascimentoAutor()));
        ...
        btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (acao.equals("insert")) {
                    editora = new Autor();
                    editora.setIdAutor(Integer.valueOf(textFieldId.getText()));
                    editora.setNomeAutor(textFieldNome.getText());
                    try {
                        editora.setDataNascimentoAutor(sdf.parse(textFieldDataNascimento.getText()));
        ...
        btnDelete.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(null,
                        "Confirma a exclusão do registro <ID = " + editora.getIdAutor() + ">?", "Confirm",
