...
public class CRUDEditora extends JDialog {
    ...
    JTextField textFieldCnpj = new JTextField(0);

    JPanel aviso = new JPanel();
    JLabel labelAviso = new JLabel("");
    String acao = "";//variavel para facilitar insert e update
    DAOEditora cl = new DAOEditora();
    Editora editora;
    Editora editoraOriginal;
    ...
    private void habilitarAtributos(boolean id, boolean nome, boolean cnpj) {
        if (id) {
        ...
        textFieldCnpj.setEditable(cnpj);
    }
    ...
    public CRUDEditora() {
        ...
        centro.add(labelCnpj);
        centro.add(textFieldCnpj);
...
// Listeners
        btnRetrieve.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if (textFieldId.getText().equals("")) {
                    ...
                    editora.setIdEditora(Integer.valueOf(textFieldId.getText()));
                    editora = cl.obter(editora.getIdEditora());
                    if (editora != null) { //se encontrou na lista
                        textFieldNome.setText(editora.getNomeEditora());
                        textFieldCnpj.setText(editora.getCnpjEditora());
                        atvBotoes(false, true, true, true);
                        habilitarAtributos(true, false, false);
                        labelAviso.setText("Encontrou - clic [Pesquisar], [Alterar] ou [Excluir]");
                        acao = "encontrou";
                        editoraOriginal = editora;
                    } else {
        ...
        btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (acao.equals("insert")) {
                    editora = new Editora();
                    editora.setIdEditora(Integer.valueOf(textFieldId.getText()));
                    editora.setNomeEditora(textFieldNome.getText());
                    editora.setCnpjEditora(textFieldCnpj.getText());
                    cl.inserir(editora);
                    habilitarAtributos(true, false, false);
                    zerarAtributos();
                    mostrarBotoes(true);
        ...
        btnList.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                acao = "list";
                ListagemEditora guiListagem = new ListagemEditora(cl.list());
            }
        });
...
//---------------------------------------------------------
        ...
        textFieldCnpj.addFocusListener(new FocusListener() { //ao receber o foco, fica verde
            @Override
            public void focusGained(FocusEvent fe) {
